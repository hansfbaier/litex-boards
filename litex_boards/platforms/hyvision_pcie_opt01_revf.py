...
_io = [
    ...
    ("ddram", 0,
        ...
        Subsignal("a",  Pins("AC8 AA7 AA8 AF7 AE7 W8 V9 Y10 Y11 Y7 Y8 W9 W10"), IOStandard("SSTL18_II")),
        Subsignal("dq", Pins(" U5  U2  U1  V3  W3 U7 V6  V4  Y2  V2  V1  W1  Y1 AB2 AC2 AA3 " + \
    ...
    ("pcie_x1", 0,
        Subsignal("rst_n", Pins("D10"), "LVCMOS33"),
